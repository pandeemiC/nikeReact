...
const Hero = () => {
  return (
    <section
      id="home"
      className="w-full flex xl:flex-row flex-col justify-center min-h-screen gap-10 max-container padding-x padding-y bg-center"
    >
      <div className="relative xl:w-2/5 flex flex-col justify-centers items-start w-full max-xl:padding-x pt-28">
